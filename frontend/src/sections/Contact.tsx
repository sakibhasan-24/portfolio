...
export default function Contact() {
  ...
  const whatsappNumber = "8801966529597"; // Replace with your WhatsApp number (with country code, no +)
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        <label className="block mb-6">
          <span className="block mb-1 font-semibold text-purple-300">Name</span>
          <input
            type="text"
            name="from_name"
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3 mt-4 bg-purple-600 hover:bg-purple-700 active:scale-95
